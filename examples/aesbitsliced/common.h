/* Author: Peter Schwabe, ported from an assembly implementation by Emilia
 Käsper Date: 2009-03-19 Public domain */
#ifndef COMMON_H
#define COMMON_H
...
#define aesround(                                                              \
  i, b0, b1, b2, b3, b4, b5, b6, b7, t0, t1, t2, t3, t4, t5, t6, t7, bskey)    \
...
#define Mul_GF16_2(                                                            \
  x0, x1, x2, x3, x4, x5, x6, x7, y0, y1, y2, y3, t0, t1, t2, t3)              \
  copy2(&t0, &x0);                                                             \
  copy2(&t1, &x1);                                                             \
  Mul_GF4(x0, x1, y0, y1, t2);                                                 \
  xor2(&t0, &x2);                                                              \
